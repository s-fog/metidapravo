...
function setDisplayType() {
  ...
  if ((typeof jQuery === "undefined" ? "undefined" : _typeof(jQuery)) === undefined || typeof jQuery === 'undefined') {
...
$('html').on('click', function (event) {
  if ($(event.target).parents('.js-mobile-menu-open').get(0) === undefined && !$(event.target).hasClass('js-mobile-menu-open') && $(event.target).parents('.js-mobile-menu').get(0) === undefined && !$(event.target).hasClass('js-mobile-menu')) {
    mobileMenu.removeClass('active');
    mobileMenuOpen.removeClass('active');
  }
});
    ...
    error: function error(_error) {
      ...
      if (_error.status === 422) {
        ...
        Object.keys(errors).map(function (objectKey, index) {
          ...
          var input = $("[name=\"".concat(objectKey, "\"]"), thisForm);
...
ymaps__WEBPACK_IMPORTED_MODULE_2__["default"].load('https://api-maps.yandex.ru/2.1/?lang=ru_RU').then(function (maps) {
  var center = [55.544489, 37.722648],
...
/***/ 0:
/*!***************************************************************************************************************************************************************************!*\
  !*** multi ./resources/js/app.js ./resources/css/app.css ./node_modules/@fancyapps/fancybox/dist/jquery.fancybox.min.css ./node_modules/tiny-slider/dist/tiny-slider.css ***!
  \***************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! /mnt/d-disk/sites/metida/resources/js/app.js */"./resources/js/app.js");
__webpack_require__(/*! /mnt/d-disk/sites/metida/resources/css/app.css */"./resources/css/app.css");
__webpack_require__(/*! /mnt/d-disk/sites/metida/node_modules/@fancyapps/fancybox/dist/jquery.fancybox.min.css */"./node_modules/@fancyapps/fancybox/dist/jquery.fancybox.min.css");
module.exports = __webpack_require__(/*! /mnt/d-disk/sites/metida/node_modules/tiny-slider/dist/tiny-slider.css */"./node_modules/tiny-slider/dist/tiny-slider.css");
