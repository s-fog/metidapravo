...
<head>
    ...
    <title>Метиправо. Юридическая фирма.</title>
</head>
<body class="">
@if(!$isMobile)
    <div class="flex
        ...
        <div>
            <img src="/svg/logo_header.svg"
                 class="absolute left-0 right-0 m-auto mt-22 w-290px transform -translate-x-14 z-10 mobile-550:static"
                 alt="">
        </div>
...
<div class="bg-grey-dark pt-25 pb-35">
    ...
    mobile-550:block">
        ...
        mobile-550:hidden">
            <img src="/svg/logo_footer.svg" width="250" alt="">
        </div>
